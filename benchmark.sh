...
DEVICE='workstation'
IN_DIR='/data/bench-data'
OUT_DIR='.'

PCA_SMALL="vanadium-cli pca --csv -i $IN_DIR/small-{type} -h $IN_DIR/small-{type}.hdr -o $OUT_DIR/pca.{type}.csv -d 3 --min 0.0 --max 1.0"
PCA_MED="vanadium-cli pca --csv -i $IN_DIR/medium-{type} -h $IN_DIR/medium-{type}.hdr -o $OUT_DIR/pca.{type}.csv -d 3 --min 0.0 --max 1.0"
...
CONVERT_IN_SMALL="vanadium-cli convert -i $IN_DIR/small-{type} -n $IN_DIR/small-{type}.hdr"
CONVERT_IN_MED="vanadium-cli convert -i $IN_DIR/medium-{type} -n $IN_DIR/medium-{type}.hdr"
